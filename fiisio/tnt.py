...
class Tnt(object):
    ...
    def __init__(self, N=1000):
        ...
        self.l3 = 0.0
        self.status = set()
        self.wd = frequence.AddOneProb()
        self.eos = frequence.AddOneProb()
        self.eosd = frequence.AddOneProb()
        self.uni = frequence.NormalProb()
        self.bi = frequence.NormalProb()
        self.tri = frequence.NormalProb()
        self.word = {}
        self.trans = {}
